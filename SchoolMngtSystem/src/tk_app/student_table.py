...
class StudentTable(ttk.Frame):
    ...
    def select_student(self):
        ...
        for s in self.dm.students_data: #looping over all students in data to find the one with the matching id
    ...
    def delete_student(self):
        ...
        if confirm:
            ...
            self.dm.students_data.remove(student)
            self.load_data()
            if self.course_table:
                self.course_table.load_data()
    ...
    def search_records(self):
        ...
        for student in self.dm.students_data:
